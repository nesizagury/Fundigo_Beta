...
public class VerifyCardActivity extends AppCompatActivity {
    ...
    CardValidCallback cardValidCallback = new CardValidCallback () {
        ...
        public void cardValid(CreditCard card) {
            Toast.makeText (VerifyCardActivity.this, "Card valid and complete", Toast.LENGTH_SHORT).show ();
            ...
            try {
                ...
                Toast.makeText (VerifyCardActivity.this, "Enjoy Yout Ticket!", Toast.LENGTH_LONG).show ();
    ...
    public void pay(View view) {
        Intent intent = new Intent (VerifyCardActivity.this, WebRequest.class);
