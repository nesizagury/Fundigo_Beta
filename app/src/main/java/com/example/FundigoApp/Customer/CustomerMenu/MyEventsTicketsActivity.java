...
public class MyEventsTicketsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TICKETS) {
            ListAdapter _adapter = new EventsListAdapter (MyEventsTicketsActivity.this, my_tickets_events_list, false);
            listT.setAdapter (_adapter);
        } else
            Toast.makeText (getApplicationContext (), "No Tickets to Display", Toast.LENGTH_SHORT).show ();

        final Intent intent = new Intent (this, EventPageActivity.class); // When click on one of the events that in the list, it will be presented
