...
public class ChatActivity extends Activity {
    ...
    private ArrayList<com.example.events.Chat.Message> mMessages;
    private com.example.events.Chat.MessageAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EventInfo eventInfo = MainActivity.all_events_data.get (eventIndex);
        ...
        mMessages = new ArrayList<com.example.events.Chat.Message> ();
        // Automatically scroll to the bottom when a data set change notification is received and only if the last item is already visible on screen. Don't scroll to the bottom otherwise.
        lvChat.setTranscriptMode (1);
        mFirstLoad = true;
        mAdapter = new com.example.events.Chat.MessageAdapter (this, mMessages);
                    ...
                    if (messages.size () > mMessages.size ()) {
                        ...
                        for (int i = 0; i < messages.size (); i++) {
                            if (messages.get (i).getCustomer ().equals (customer)) {
                                ...
                                mMessages.add (new com.example.events.Chat.Message (
                                                                                           com.example.events.Chat.Message.MSG_TYPE_TEXT,
                                                                                           com.example.events.Chat.Message.MSG_STATE_SUCCESS,
                                                                                           id,
                                                                                           "avatar",
                                                                                           "Jerry",
                                                                                           "avatar",
